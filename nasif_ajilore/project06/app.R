...
custom_css <- "
  .skin-blue .main-header .logo { font-weight: bold; font-size: 16px; }
  .content-wrapper { background-color: #ecf0f5; }
  .small-box .inner h3 { font-size: 32px; }
  .small-box .inner p  { font-size: 13px; }
  .box.box-solid.box-primary > .box-header { background-color: #2c3e50; }
  .box.box-solid.box-info    > .box-header { background-color: #2980b9; }
  .box.box-solid.box-success > .box-header { background-color: #27ae60; }
  .box.box-solid.box-warning > .box-header { background-color: #e67e22; }
  .nav-tabs-custom > .tab-content { padding: 15px; }
  .sidebar-menu li a { font-size: 14px; }
  #reset_filters { margin-top: 10px; }
"
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem("overview",
        ...
        fluidRow(
          box(title = "Monthly Homicides by Year", status = "primary",
              solidHeader = TRUE, width = 8,
              plotlyOutput("plot_monthly", height = "340px")),
          box(title = "Case Status Breakdown", status = "success",
              solidHeader = TRUE, width = 4,
              plotlyOutput("plot_status_pie", height = "340px"))
        ),
        fluidRow(
          box(title = "Top 15 Locations", status = "info",
              solidHeader = TRUE, width = 6,
              plotlyOutput("plot_locations", height = "340px")),
          box(title = "Yearly Comparison", status = "info",
              solidHeader = TRUE, width = 6,
      ...
      tabItem("demographics",
        ...
        fluidRow(
          box(title = "Age Distribution", status = "primary",
              solidHeader = TRUE, width = 6,
              plotlyOutput("plot_age_hist", height = "360px")),
          box(title = "Age Groups by Year", status = "info",
              solidHeader = TRUE, width = 6,
